...
class Spring2018CmuExperimentMailer < ApplicationMailer
  ...
  def email(course, instructor, email_code, reminder: false)
    ...
    @opt_in_link = "https://#{ENV['dashboard_url']}/experiments/spring2018_cmu_experiment/#{@course.id}/#{email_code}/opt_in"
    @opt_out_link = "https://#{ENV['dashboard_url']}/experiments/spring2018_cmu_experiment/#{@course.id}/#{email_code}/opt_out"
