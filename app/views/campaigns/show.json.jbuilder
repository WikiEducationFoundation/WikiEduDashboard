...
if @campaign
  json.campaign do
    ...
    json.new_article_count_human number_to_human(@presenter.new_article_count)
    ...
    json.view_sum_human number_to_human(@presenter.view_sum)
    json.article_count_human number_to_human(@presenter.article_count)
    json.upload_count_human number_to_human(@presenter.upload_count)
