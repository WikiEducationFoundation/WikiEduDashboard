...
const CourseRow = ({ course }) => {
  return (
    <tr>
      ...
      <td className="table-link-cell school">
        <a href={`/courses/${course.slug}/`}>{`${course.school}/${course.term}`}</a>
      </td>
      {
        Features.wikiEd && (
          <td className="table-link-cell instructor">
            <a href={`/courses/${course.slug}/`}>{course.instructor}</a>
          </td>
        )
      }
