...
Milestones    = require('./milestones.jsx').default
Details       = require('./details.jsx').default
ThisWeek      = require('./this_week.jsx').default
CourseStore   = require '../../stores/course_store.coffee'
AssignmentStore = require('../../stores/assignment_store.js').default
