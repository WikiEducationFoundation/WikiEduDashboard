    ...
    if (this.props.view === LIST_VIEW) {
      ...
      return (
        <tr className="upload list-view" onClick={this.isUploadViewerOpen}>
          ...
          <td className="desktop-only-tc">{formatWithTime(this.props.upload.uploaded_at)}</td>
      ...
      return (
        <div className="upload" style={uploadDivStyle} onClick={this.isUploadViewerOpen} >
          ...
          <div className="info">
            ...
            <p><b>{I18n.t('uploads.uploaded_on')}</b>&nbsp;{formatWithTime(this.props.upload.uploaded_at)}</p>
          </div>
        </div>
      );
        ...
        <div className="tile-container" onClick={this.isUploadViewerOpen}>
          <div className="tile">
            ...
            <div className="info">
              ...
              <p className="uploader"><b>{I18n.t('uploads.uploaded_by')} {uploader}</b></p>
              <p>
                <b>{I18n.t('uploads.uploaded_on')}</b>&nbsp;{formatWithTime(this.props.upload.uploaded_at)}
              </p>
            </div>
          </div>
        </div>
