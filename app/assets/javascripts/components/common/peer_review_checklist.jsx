    ...
    if (!this.state.show) {
      ...
      modal = (
        <div className="article-viewer my-assignment-checklist">
          ...
          <p>
            Your goal with a peer review is provide identify specific ways the article could be improved, and identify any major problems that ought to be fixed. Consider these questions:
          </p>
          <dl>
            ...
            <dd><input type="checkbox" /> Is each fact referenced with an appropriate, reliable reference? Where does the information come from? Are these neutral sources? If biased, is that bias noted?</dd>
            <dd><input type="checkbox" /> Is any information out of date? Is anything missing that could be added?</dd>
          </dl>
          {button}
        </div>
      );
