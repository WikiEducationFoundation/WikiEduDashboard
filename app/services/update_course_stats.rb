...
require_dependency Rails.root.join('lib/course_revision_updater')
require_dependency Rails.root.join('lib/article_status_manager')
require_dependency Rails.root.join('lib/importers/course_upload_importer')
