...
ActiveRecord::Schema[7.0].define(version: 2022_08_15_143028) do
  ...
  create_table "articles_courses", id: :integer, charset: "utf8", force: :cascade do |t|
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
    t.integer "article_id"
    t.integer "course_id"
  ...
  create_table "assignment_suggestions", charset: "utf8", force: :cascade do |t|
    t.text "text"
  ...
  create_table "blocks", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "kind"
    t.text "content"
    t.integer "week_id"
    t.datetime "created_at", precision: nil
  ...
  create_table "campaigns_courses", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "campaigns_survey_assignments", id: false, charset: "utf8", force: :cascade do |t|
  ...
  create_table "campaigns_users", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "campaign_id"
    t.integer "user_id"
  ...
  create_table "categories_courses", charset: "utf8", force: :cascade do |t|
  ...
  create_table "commons_uploads", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "course_wiki_namespaces", charset: "utf8", force: :cascade do |t|
    t.integer "namespace"
  ...
  create_table "courses_users", id: :integer, charset: "utf8", force: :cascade do |t|
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
    t.integer "course_id"
    t.integer "user_id"
  ...
  create_table "courses_wikis", charset: "utf8", force: :cascade do |t|
    t.integer "course_id"
    t.integer "wiki_id"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "faqs", charset: "utf8", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "feedback_form_responses", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "subject"
    t.text "body"
    t.integer "user_id"
    t.datetime "created_at", precision: nil
  ...
  create_table "question_group_conditionals", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "rapidfire_answer_groups", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "rapidfire_answers", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "rapidfire_question_groups", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
    t.string "tags"
  ...
  create_table "rapidfire_questions", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "question_group_id"
    t.string "type"
  ...
  create_table "requested_accounts", charset: "utf8", force: :cascade do |t|
    t.integer "course_id"
    t.string "username"
    t.string "email"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "revisions", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "survey_assignments", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "survey_notifications", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "surveys_question_groups", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "survey_id"
    t.integer "rapidfire_question_group_id"
    t.integer "position"
    t.datetime "created_at", precision: nil
  ...
  create_table "ticket_dispenser_messages", charset: "utf8", force: :cascade do |t|
  ...
  create_table "ticket_dispenser_tickets", charset: "utf8", force: :cascade do |t|
    t.bigint "project_id"
    t.integer "owner_id"
  ...
  create_table "training_libraries", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "wiki_page"
    t.string "slug"
    t.text "introduction"
  ...
  create_table "training_modules", charset: "utf8", force: :cascade do |t|
    t.string "name"
  ...
  create_table "training_modules_users", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "trigrams", charset: "utf8", force: :cascade do |t|
  ...
  create_table "user_profiles", id: :integer, charset: "utf8", force: :cascade do |t|
    t.text "bio"
    t.integer "user_id"
  ...
  create_table "weeks", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.integer "course_id"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
