...
ActiveRecord::Schema[8.1].define(version: 2026_05_27_000001) do
  ...
  create_table "article_course_user_wiki_timeslices", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.integer "article_id", null: false
    t.integer "character_sum", default: 0
    t.integer "course_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "backups", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "end"
  ...
  create_table "lti_contexts", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
