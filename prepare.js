...
copyPaths.forEach(entry => {
  ...
  switch(idx) {
    case 0: console.log('\x1b[33m%s\x1b[0m', 'Finished copying jQuery ' + elapsed(process.hrtime(start)) + ' seconds'); break;
    case 1: console.log('\x1b[33m%s\x1b[0m', 'Finished copying images ' + elapsed(process.hrtime(start)) + ' seconds'); break;
    case 2: console.log('\x1b[33m%s\x1b[0m', 'Finished copying fonts ' + elapsed(process.hrtime(start)) + ' seconds'); break;
    case 3: console.log('\x1b[33m%s\x1b[0m', 'Finished copying tinymce skins ' + elapsed(process.hrtime(start)) + ' seconds'); break;
    default: console.log('\x1b[33m%s\x1b[0m', 'Finished copying static assets ' + elapsed(process.hrtime(start)) + ' seconds'); break;
  }
  idx++;
});
