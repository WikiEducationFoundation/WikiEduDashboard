...
# Student demographics survey responses by course
QUESTION_ID = 1924
q = Rapidfire::Question.find(QUESTION_ID)
responses = q.answers.to_a
responses_by_course = responses.map { |a| [(a.user.courses.last&.slug or puts a.id), a.answer_text] }
pp responses_by_course
