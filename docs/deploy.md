...
1. Work through the pre-push checklist defined below
2. Push updates to the repository (Github)
3. If your code includes a migration you must pause CRON jobs on your target server. Run the following task and wait 30 minutes to allow any existing updates to end.
