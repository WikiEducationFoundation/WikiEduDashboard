          ...
          describe('status testing', () => {
            describe('progress', () => {
              ...
              it('in-progress', () => {
                ...
                const TrainingModulesTEMP = mount(<Provider store={store}><TrainingModules isStudent={true} block_modules={[testTemp]} editable={false} trainingLibrarySlug="students" /></Provider>);
