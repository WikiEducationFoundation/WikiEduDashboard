...
describe SurveysAnalyticsHelper, type: :helper do
  describe '#assignment_response' do
    before do
      ...
      @survey_assignment.survey_notifications << create(:survey_notification,
          survey_assignment_id: @survey_assignment.id, completed: true)
      @survey_assignment.survey_notifications << create(:survey_notification,
          survey_assignment_id: @survey_assignment.id, completed: false)
      @survey_assignment.survey_notifications << create(:survey_notification,
          survey_assignment_id: @survey_assignment.id, completed: false)
    end
