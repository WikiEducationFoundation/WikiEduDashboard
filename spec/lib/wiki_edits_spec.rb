...
describe WikiEdits do
  ...
  it 'handles failed token requests' do
    ...
    result = described_class.new.post_whole_page(User.first, 'Foo', 'Bar')
  ...
  it 'handles edit requests that are blocked' do
    ...
    described_class.new.post_whole_page(User.first, 'Foo', 'Bar')
  end
  ...
  describe '.notify_users' do
    it 'posts talk page messages on Wikipedia' do
      ...
      described_class.new.notify_users(User.first, User.all, params)
    end
  end
  ...
  describe '.oauth_credentials_valid?' do
    it 'returns true if credentials are valid' do
      stub_token_request
      response = described_class.new.oauth_credentials_valid?(User.first)
