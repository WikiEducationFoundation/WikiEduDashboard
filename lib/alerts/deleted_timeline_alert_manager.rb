...
class DeletedTimelineAlertManager
  ...
  def create_alerts
    ...
    alert = Alert.create(type: 'DeletedTimelineAlert', course_id: @course.id, message: "It appears you have removed either the timeline, week or block from your course.")
